...
export const APP_INTRO =
  'ラスサバ・イニブの設置店舗を地図でまとめて確認できる非公式の個人開発サイトです。'
...
export const PRIVACY_NOTE =
  ...
  'サイト改善のため、Google Analyticsでアクセス状況を、Sentryでエラー情報を匿名で収集しています。' +
  '入力フォームの内容や個人を特定できる情報はマスキングし、送信しません。'

/** 免責（モーダル・/about 共有）。 */
export const DISCLAIMER =
  '本サイトはファン制作の非公式サービスであり、株式会社バンダイナムコアミューズメント等の権利者とは一切関係ありません。'
