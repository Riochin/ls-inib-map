    ...
    <html lang="ja">
      <head>
        {/*
          ...
          このアプリについて／データとプライバシー／その台数、「信じていい？」がわかる。／
