...
/**
 * トップページ本体（地図アプリ・Client Component）。
 *
 * 旧 `app/page.tsx` の中身。`app/page.tsx` は Server Component として
 * {@link SeoContent}（h1・全県リンク）と本コンポーネントを並べるだけの薄い入口にし、
 * SEO 本文をサーバー側で静的に出しつつ地図はクライアントで動かす。
 */
